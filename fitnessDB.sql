...
-- workout
insert into workout(dateOfWorkOut, workOutName) values ('2022-09-05', 'TryOuts');
insert into workout(dateOfWorkOut, workOutName) values ('2022-09-06', 'LegDay');
insert into workout(dateOfWorkOut, workOutName) values ('2022-09-05', 'CardioDay');

insert into workout_exercise(workoutId, exerciseId, caloriesBurned, durationsMins) values (1, 1, 100, 20);
insert into workout_exercise(workoutId, exerciseId, caloriesBurned, durationsMins) values (1, 2, 150, 25);
insert into workout_exercise(workoutId, exerciseId, caloriesBurned, durationsMins) values (2, 3, 200, 30);
insert into workout_exercise(workoutId, exerciseId, caloriesBurned, durationsMins) values (2, 4, 250, 35);
insert into workout_exercise(workoutId, exerciseId, caloriesBurned, durationsMins) values (3, 5, 300, 40);
insert into workout_exercise(workoutId, exerciseId, caloriesBurned, durationsMins) values (3, 6, 350, 45);
